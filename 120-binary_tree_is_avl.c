...
/**
 * isBST - A function that checks if each node has a value less than
 * itself in the left
 * @root: node to check
...
/**
 * tree_is_bst - A function that checks if a binary tree is a valid Binary Search Tree
...
/**
 * avl_check - A function that checks if a binary tree is a valid AVL Tree
