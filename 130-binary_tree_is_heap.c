...
/**
 * b_height - A function that returns the number of nodes
 * of a binary tree
 * @tree: Tree to check
 *
...
/**
 * is_complete - A function that checks if the tree is complete
 * @root: Tree to check
 * @index: Initial Level
...
/**
 * is_heap - A function that checks if a subtree or tree is perfect
