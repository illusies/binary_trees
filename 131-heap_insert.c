...
/**
 * _height - A function that measures the sum of the heights of a binary tree
...
/**
 * greater_than_parent - A function that checks if the child 
 * is greather than the parent to check
...
/**
 * is_perfect - A function that checks if the subtrees has the same height
 * and check if each subtree is perfect
